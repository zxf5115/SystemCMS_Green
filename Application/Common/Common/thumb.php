 ...
 * @auth 陈一枭
 */
function getThumbImage($filename, $width = 'auto', $height = 'auto', $type = 0, $replace = false)
{
  $UPLOAD_URL  = '';
  $UPLOAD_PATH = '';
  ...
  else 
  {
    ...
    else 
    {
      ...
      if ($width == "auto")
      { 
        $width = round($old_image_width / round($old_image_height / $height));
...
function getThumbImageById($cover_id, $width = 'auto', $height = 'auto', $type = 0, $replace = false)
{
