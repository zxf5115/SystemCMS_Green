...
<body>
  ...
  <div class="row">
    ...
    <?php if(is_array($list["merit"])): $i = 0; $__LIST__ = $list["merit"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$uo): $mod = ($i % 2 );++$i; if(is_array($uo)): $i = 0; $__LIST__ = $uo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$io): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Service/merit', array('id'=>$io['id']));?>">
          <div class="span4">
            <div class="span1">
              <img src="<?php echo ($io["picture"]); ?>" style="width:50px;height:50px;"/>
            </div>
            <div class="span2" style="margin-left:0px;">
              <div ><?php echo ($io["title"]); ?></div>
              <div><?php echo ($io["content"]); ?></div>
            </div>
          </div>
        </a><?php endforeach; endif; else: echo "" ;endif; ?>

      <div class="row space30"></div><?php endforeach; endif; else: echo "" ;endif; ?>
  </div>
  ...
  <div class="slider2 flexslider">
    <ul class="slides">
    <?php if(is_array($list["client"])): $i = 0; $__LIST__ = $list["client"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
          <div class="row">
            <?php if(is_array($vo)): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xo): $mod = ($i % 2 );++$i;?><div class="span3">
                <a href="<?php echo (set_url_format($xo["url"])); ?>" target="_blank">
