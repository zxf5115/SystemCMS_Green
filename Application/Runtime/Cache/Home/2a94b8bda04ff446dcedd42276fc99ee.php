...
<body>
  ...
  <div class="content">
    ...
    <div class="span12">
      ...
      <div class="slider1 flexslider">
        <!-- Items -->
        <ul class="slides">
        	<?php if(is_array($list["picture"])): $i = 0; $__LIST__ = $list["picture"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
	            <!-- Item -->
		    	    <img src="<?php echo ($vo["picture"]); ?>" alt="<?php echo ($vo["title"]); ?>" style="width:1170px;height:555px;">
  ...
  <div class="row">
    <?php if($item): if(is_array($item)): $k = 0; $__LIST__ = $item;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><a href="<?php echo U('Item/detail', array('id'=>$vo['id']));?>">
          <div class="span6 square-1">
            <div class="img-container">
              <img src="<?php echo ($vo["picture"]); ?>" style="max-height:422px;">
  ...
  <div class="row">
    <?php if($note): if(is_array($note)): $k = 0; $__LIST__ = $note;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><a href="<?php echo U('Note/detail', array('id'=>$vo['id']));?>">
          <div class="span4 square-1">
            <div class="img-container">
              <img src="<?php echo ($vo["picture"]); ?>" style="max-height:274px;">
              <div class="img-bg-icon"></div>
            </div>
            <h3><?php echo ($vo["title"]); ?></h3>
            <div><?php echo ($vo["content"]); ?></div>
  ...
  <div class="slider2 flexslider">
    <ul class="slides">
      <?php if($list['merit']): if(is_array($list["merit"])): $i = 0; $__LIST__ = $list["merit"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
            <div class="row">
              <?php if(is_array($vo)): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Service/merit', array('id'=>$xo['id']));?>">
                  <div class="span3 square-1">
                    <div class="img-container">
                      <img src="<?php echo ($xo["picture"]); ?>" class="picture_format">
                      <div class="img-bg-icon" ></div>
                    </div>
                    <h3 ><?php echo ($xo["title"]); ?></h3>
                    <div><?php echo ($xo["content"]); ?></div>
                  </div>
