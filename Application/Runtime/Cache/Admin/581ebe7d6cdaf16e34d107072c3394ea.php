    ...
    <div class="col-sm-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form action="<?php echo U('Merit/add');?>" method="post"  role="form" class="form form-horizontal validate">
            <div class="panel-body">
              <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input name="title" type="text" class="form-control" placeholder="请输入擅长名称，长度不超过二十个字（必须）">
              </div>
            </div>
