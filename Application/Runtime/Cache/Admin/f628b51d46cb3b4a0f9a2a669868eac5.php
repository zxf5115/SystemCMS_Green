    ...
    <div class="col-sm-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form action="<?php echo U('Publicity/edit');?>" method="post"  role="form" class="form form-horizontal validate">
            <div class="panel-body">
              <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input name="title" value="<?php echo ($list["title"]); ?>" type="text" class="form-control" placeholder="请输入广告标题，长度不超过二十个字（必须）">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input name="english" value="<?php echo ($list["english"]); ?>" type="text" class="form-control" placeholder="请输入广告英文标题，长度不超过一百个字（必须）">
              </div>
            </div>
...
<script src="/Public/Admin/js/common.js"></script>
  ...
  <script type="text/javascript">
    ...
    {
      Think.setValue('category', <?php echo ((isset($list['category']) && ($list['category'] !== ""))?($list['category']):"0"); ?>);
      Think.setValue('sort', <?php echo ((isset($list['sort']) && ($list['sort'] !== ""))?($list['sort']):"0"); ?>);
