    ...
    <div class="col-sm-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form action="<?php echo U('Admin/User/edit');?>" method="post"  role="form" class="form form-horizontal validate">
            <div class="panel-body">
              <div class="row">
                  ...
                  <table class="table table-bordered table-striped" id="preview">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a href='<?php echo ($list["0"]["picture"]); ?>' target='_black'>
                            <img src='<?php echo ($list["0"]["picture"]); ?>' style='width:30px;'/>
                          </a>
                        </td>
                        <td><span class="text-success">成功</span></td>
                        <td>
                          <span class="text-error remove_hand" onclick="$.custom_remove(this);">删除</span>
                          <input name='picture' type='hidden' value='<?php echo ($list["0"]["picture"]); ?>'/>
                        </td>
                      </tr>
                    </tbody>
                  </table>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label red">账户名称</label>

              <div class="col-sm-10">
                <input name="username" value="<?php echo ($list["0"]["username"]); ?>" type="text" class="form-control" placeholder="请输入账户名称">
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label red">显示昵称</label>

              <div class="col-sm-10">
                <input name="nickname" value="<?php echo ($list["0"]["nickname"]); ?>" type="text" class="form-control" placeholder="请输入显示昵称">
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label red">联系邮箱</label>

              <div class="col-sm-10">
                <input name="email" value="<?php echo ($list["0"]["email"]); ?>" type="email" class="form-control" placeholder="请输入联系邮箱">
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label red">联系电话</label>

              <div class="col-sm-10">
                <input name="mobile" value="<?php echo ($list["0"]["mobile"]); ?>" type="text" class="form-control" placeholder="请输入联系电话">
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label">联系扣扣</label>

              <div class="col-sm-10">
                <input name="qq" value="<?php echo ($list["0"]["qq"]); ?>" type="text" class="form-control" placeholder="请输入联系QQ">
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label">账户性别</label>

              <div class="col-sm-10">
                <select class="form-control" name="sex">
                  <option value="">请选择账户性别</option>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input name="birthday" value="<?php echo ($list["0"]["birthday"]); ?>" class="form-control" data-mask="date" placeholder="请输入出生年月"/>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select class="form-control" name="province">
                  ...
                  <?php if(is_array($list['province'])): $i = 0; $__LIST__ = $list['province'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <textarea name="description" class="form-control" rows="10" placeholder="请输入个人介绍"><?php echo ($list["0"]["description"]); ?></textarea>
              </div>
            </div>

            <div class="form-group">
            	<div class="hidden">
            		<input type="hidden" name="id" class="form-control"  autocomplete="off" value="<?php echo ($list["0"]["id"]); ?>"/>
            	</div>
            </div>
...
<script src="/Public/Admin/js/common.js"></script>
  ...
  <script type="text/javascript">
    $(function()
    {
      $('select[name="sex"]').val('<?php echo ($list["0"]["sex"]); ?>');
      $('select[name="province"]').val('<?php echo ($list["0"]["province"]); ?>');
