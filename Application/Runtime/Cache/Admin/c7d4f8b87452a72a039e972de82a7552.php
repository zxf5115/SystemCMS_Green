    ...
    <div class="col-sm-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form action="<?php echo U('About/edit');?>" method="post"  role="form" class="form form-horizontal validate">

            <div class="form-group-separator"></div>

            <div class="form-group">
              <label class="col-sm-2 control-label red">标题</label>

              <div class="col-sm-10">
                <input name="title" value="<?php echo ($list["title"]); ?>" type="text" class="form-control" placeholder="请输入标题">
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label red">内容 </label>
              ...
              <div class="row">
                <div class="col-sm-2 text-right">
                  <div class="droppable-area">
                    ...
                    <input type="file" id="upload" class="custom-file" multiple>
                  </div>
                </div>
                <div class="col-sm-10">
                  <table class="table table-bordered table-striped" id="preview">
                    ...
                    <tbody>
                      <?php if(!empty($list['rel'])): if(is_array($list["rel"])): $k = 0; $__LIST__ = $list["rel"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($k % 2 );++$k;?><tr>
                            <td class="text-center"><?php echo ($k); ?></td>
                            <td>
                              <a href='<?php echo ($voo["url"]); ?>' target='_black'>
                                <img src='<?php echo ($voo["url"]); ?>' style='width:30px;'/>
                              </a>
                            </td>
                            <td><span class="text-success">成功</span></td>
                            <td>
                              <span class="text-error remove_hand" onclick="$.custom_remove(this);">删除</span>
                              <input name='url[]' type='hidden' value='<?php echo ($voo["url"]); ?>'/>
                            </td>
