    ...
    <div class="col-sm-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <div style="float:left;">
            <select name="role" class="form-control" >
              <?php if(is_array($group)): $k = 0; $__LIST__ = $group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><option value="<?php echo U('Config/setting',array('id'=>$k));?>" <?php if(($id) == $k): ?>selected<?php endif; ?> ><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
          </div>
        ...
        <div class="panel-body">
          <form action="<?php echo U('Config/setting');?>" method="post"  role="form" class="form form-horizontal validate">
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$config): $mod = ($i % 2 );++$i;?><div class="form-group">
                <label class="col-sm-2 control-label" for="field-1"><?php echo ($config["title"]); ?></label>
                <div class="col-sm-10">
                  <?php switch($config["type"]): case "0": ?><input type="text" class="form-control" name="config[<?php echo ($config["name"]); ?>]" value="<?php echo ($config["value"]); ?>" placeholder="<?php echo ($config["title"]); ?>"><?php break;?>
                    <?php case "1": ?><input type="text" class="form-control" name="config[<?php echo ($config["name"]); ?>]" value="<?php echo ($config["value"]); ?>" placeholder="<?php echo ($config["title"]); ?>"><?php break;?>
                    <?php case "2": ?><textarea name="config[<?php echo ($config["name"]); ?>]" class="form-control" placeholder="<?php echo ($config["title"]); ?>"><?php echo ($config["value"]); ?></textarea><?php break;?>
                    <?php case "3": ?><textarea name="config[<?php echo ($config["name"]); ?>]" class="form-control" placeholder="<?php echo ($config["title"]); ?>"><?php echo ($config["value"]); ?></textarea><?php break;?>
              ...
              <div class="form-group-separator"></div><?php endforeach; endif; else: echo "" ;endif; ?>
