    ...
    <div class="col-sm-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form action="<?php echo U('User/authorization');?>" method="post"  role="form" class="form form-horizontal validate">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <?php if(is_array($role)): $k = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                    <td class="td text-center hidden-xs"><?php echo ($vo["id"]); ?></td>
                    <td class="td text-center hidden-xs"><?php echo ($vo["title"]); ?></td>
                    <td class="td hidden-xs"><?php echo ($vo["description"]); ?></td>
                    <td class="td text-center text-primary text-bold">
                      <input type="radio" class="role cbr cbr-success" name="rid[]" value="<?php echo ($vo["id"]); ?>"/>
                    </td>
