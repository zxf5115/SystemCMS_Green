    ...
    <div class="col-sm-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form action="<?php echo U('Item/edit');?>" method="post"  role="form" class="form form-horizontal validate">
            <div class="panel-body">
              <div class="row">
                  ...
                  <table class="table table-bordered table-striped" id="preview">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a href='<?php echo ($list["picture"]); ?>' target='_black'>
                            <img src='<?php echo ($list["picture"]); ?>' style='width:30px;'/>
                          </a>
                        </td>
                        <td><span class="text-success">成功</span></td>
                        <td>
                          <span class="text-error remove_hand" onclick="$.custom_remove(this);">删除</span>
                          <input name='picture' type='hidden' value='<?php echo ($list["picture"]); ?>'/>
                        </td>
                      </tr>
                    </tbody>
                  </table>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input name="title" value="<?php echo ($list["title"]); ?>" type="text" class="form-control" placeholder="请输入项目名称">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select id="select2" name="cid[]" class="form-control" placeholder="请选择分类" multiple>
                  <?php if(is_array($list["category"])): $i = 0; $__LIST__ = $list["category"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select id="select3" name="lid[]" class="form-control" placeholder="请选择标签" multiple>
                  <?php if(is_array($list["label"])): $i = 0; $__LIST__ = $list["label"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <?php echo W('UeditorMini/editor',array('myeditor','content',$list['content'], U('File/uploadImageUE')));?>
              </div>
            </div>
