  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div style="float:left;">
        <button class="btn btn-turquoise btn-add " id="action_add" url="<?php echo U('Role/visit', array('rid'=> I('rid')));?>">
          访问授权
        </button>
      ...
      <div style="float:left;margin-left:10px;">
        <select name="role" class="form-control" >
          <?php if(is_array($role)): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo U('Role/user',array('rid'=>$vo['id']));?>" <?php if(($vo['id']) == $current['id']): ?>selected<?php endif; ?> ><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
      </div>
      ...
      <table class="table table-bordered table-striped" id="dataTables">
        ...
        <tbody class="middle-align">
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td>
                <span><?php echo (time_format($vo["last_login_time"])); ?></span>
              </td>
              <td>
                <span><?php echo (long2ip($vo["last_login_ip"])); ?></span>
              </td>
              <td><?php echo ($vo["status_text"]); ?></td>
              <td>
                <a href="<?php echo U('Role/removeUser', array('uid'=>$vo['id'], 'rid'=>I('rid')));?>" class='btn btn-info btn-sm btn-icon icon-left ajax-get'>解除授权</a>
              </td>
