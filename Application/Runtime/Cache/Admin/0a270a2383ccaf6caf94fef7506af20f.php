    ...
    <div class="col-sm-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form action="<?php echo U('Client/edit');?>" method="post"  role="form" class="form form-horizontal validate">
            <div class="panel-body">
              <div class="row">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label red">客户名称</label>

              <div class="col-sm-10">
                <input name="title" value="<?php echo ($list["title"]); ?>" type="text" class="form-control" placeholder="请输入客户名称，长度不超过二十个字（必须）">
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label red">链接地址</label>

              <div class="col-sm-10">
                <input name="url" value="<?php echo ($list["url"]); ?>" type="text" class="form-control" placeholder="请输入链接地址（必须）">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select name="oid" class="form-control red">
                  ...
                  <?php if(is_array($list["service"])): $i = 0; $__LIST__ = $list["service"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
              </div>
            </div>
