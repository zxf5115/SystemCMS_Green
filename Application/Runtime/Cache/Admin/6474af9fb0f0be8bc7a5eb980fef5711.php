    ...
    <div class="col-sm-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form action="<?php echo U('Note/add');?>" method="post"  role="form" class="form form-horizontal validate">
            <div class="form-group">
              <label class="col-sm-2 control-label red">随笔标题</label>

              <div class="col-sm-10">
                <input name="title" type="text" class="form-control" placeholder="请输入随笔标题">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <?php echo W('UeditorMini/editor',array('myeditor','content','', U('File/uploadImageUE')));?>
              </div>
            </div>
