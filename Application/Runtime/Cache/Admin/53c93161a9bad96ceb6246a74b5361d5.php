    ...
    <div class="col-sm-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form action="<?php echo U('Person/edit');?>" method="post"  role="form" class="form form-horizontal validate">
            <div class="panel-body">
              <div class="row">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label red">人物名称</label>

              <div class="col-sm-10">
                <input name="title" value="<?php echo ($list["title"]); ?>" type="text" class="form-control" placeholder="请输入人物名称，长度不超过二十个字（必须）">
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label red">人物内容</label>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select name="oid" class="form-control red">
                  <option value="">请选择所属关于我们</option>
                  <?php if(is_array($list["about"])): $i = 0; $__LIST__ = $list["about"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
              </div>
            </div>
...
<script src="/Public/Admin/js/common.js"></script>
  ...
  <script type="text/javascript">
    ...
    {
      Think.setValue('oid', <?php echo ((isset($list['oid']) && ($list['oid'] !== ""))?($list['oid']):"0"); ?>);
