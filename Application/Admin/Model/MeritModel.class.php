...
class MeritModel extends CommonModel
{
  private $table = 'merit'; # 擅长信息表
  ...
  protected $_validate = array(
    array('title', 'require', '擅长名称是必须填写的', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
    array('title','0,20','擅长名称多于二十个字，请进行删减',self::EXISTS_VALIDATE,'length', self::MODEL_BOTH),
    array('content', 'require', '擅长内容是必须填写的', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
