...
{
  private $table = 'category'; # 分类模型信息表
  ...
  protected $_validate = array(
    ...
    array('title', '0,20', '分类名称长度不能超过二十个字符', self::MUST_VALIDATE, 'length', self::MODEL_BOTH),
    array('description', '0,200', '分类描述不能超过二百个字符', self::MUST_VALIDATE, 'length', self::MODEL_BOTH)
  );
