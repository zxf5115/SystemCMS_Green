...
class NoteModel extends CommonModel
{
  ...
  protected $_validate = array(
    array('title', 'require', '随笔标题不能为空', self::EXISTS_VALIDATE, 'regex', self::MODEL_BOTH),
    array('title', '0,100','随笔标题多于一百个字，请进行删减。',self::EXISTS_VALIDATE, 'length', self::MODEL_BOTH),
