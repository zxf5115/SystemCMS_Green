 ...
 * @filename
 *     @chinese: 数据库控制器
 *     @english: DatabaseController.class.php
 *
 * @version: 1.0
 * @desc   : 数据库控制器
 *
...
class DatabaseController extends AdminController
{
  ...
  public function index()
  {
    ...
    {
      # 可以排序的字段
      $keys = array('TABLE_ROWS','TABLE_NAME');

      $search_fields = 'TABLE_ROWS|TABLE_NAME';

      $this->getWithWhereTablePagingInfo('', 'Database', $keys, $search_fields, $get, 'id', 'conference');
  ...
  public function export($tables = null, $id = null, $start = null)
  {
    ...
    elseif (IS_GET && is_numeric($id) && is_numeric($start))
    {
      ...
      elseif (0 === $start)
      {
        ...
        # 记录行为
        record_log('backups', 'Database', 0, UID);
      }
      else
      {
  ...
  public function import($time = 0, $part = null, $start = null)
  {
    ...
    elseif(is_numeric($part) && is_numeric($start))
    {
      ...
      elseif(0 === $start)
      {
        ...
        {
          # 记录行为
          record_log('undo', 'Database', 0, UID);
